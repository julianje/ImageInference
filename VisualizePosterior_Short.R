...
# Load everything ------------------------------------------
Threshhold <- 0.0025 #Only plot trajectories with probability higher than this:
TrialName = "UN_DX_A"
...
PlotPath <- function(trialname){
  ...
  ggsave(paste("Visualizations/",gsub("States_Posterior.csv",Threshhold,trialname),".pdf",sep=""))
}
