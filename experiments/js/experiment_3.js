...
// Set up the catch trial slide.
  ...
  function start() {
    ...
    $(".stimulus").html(
      ...
      "<img src=\"../stimuli/experiment_3/B.png\" alt=\"\" style=\"width:35px;height:auto;\">" +
      "</label>" +
      "<label><input type=\"radio\" name=\"objective\" value=\"C\"/>" + 
      "<img src=\"../stimuli/experiment_3/C.png\" alt=\"\" style=\"width:35px;height:auto;\">" +
      "</label>" +
      "</div>");

    exp.questions = ["How many people were in the room?"];
    ...
    $("#multi_slider_table_" + j).append(
      ...
      "<tr>" +
      "<td></td>" +
       "<td style=\"text-align:left;\">definitely one</td>" +
       "<td style=\"text-align:right;\">definitely two</td>" +
      "</tr>" +
      "<tr class=\"slider_row\">" +
      "<td class=\"slider_target\">" +
      "</td>" +
      "<td colspan=\"2\">" + 
      "<div id=\"num_agents\" class=\"slider\">-------[ ]--------</div>" + 
      "</td>" +
      "</tr>");
    
    utils.match_row_height("#multi_slider_table_" + j, ".slider_target");
    utils.make_slider("#num_agents", make_slider_callback(0));
  ...
  function button() {
    ...
    if ((exp.sliderPost[0] === undefined) || (exp.objective === undefined)) { 
        $(".trial_error").show();
    }
    else if (incorrect) {
      $(".trial_error").hide();
